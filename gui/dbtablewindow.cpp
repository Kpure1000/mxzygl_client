...
{
    auto tbviewer = new DBTableViewer(this);
    ...
    auto infotable = new InfoTableWidget(tbviewer->getTableInfo(), 1, false, false, this);
    ...
    connect(tbviewer, &DBTableViewer::onTBPullSuccessful, this, [=](){
        infotable->refresh();
    ...
    connect(tbviewer, &DBTableViewer::onResponsing, this, [=](const QString & info, bool is_continue){
